...
| 3 | Sibling clone | `<binary-dir>/movie-cli-v6/` |
...
- A `go.mod` file with module `github.com/alimtvnetwork/movie-cli-v6`
...
1. Print: `📥 No local repo found. Cloning to: <binary-dir>/movie-cli-v6/`
2. Run: `git clone --depth 1 https://github.com/alimtvnetwork/movie-cli-v6.git`
...
```
movie update --repo-path C:\dev\movie-cli-v6
```
...
func resolveRepoPath() string {
    ...
    // 3. Sibling clone
    sibling := filepath.Join(exeDir, "movie-cli-v6")
